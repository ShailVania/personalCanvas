...
export default function Home() {
  return (
    <div className="relative flex h-full min-h-[calc(100vh-10rem)] flex-col items-center justify-center overflow-hidden rounded-lg bg-background/50 backdrop-blur-sm">
      <ThreeCanvas />
